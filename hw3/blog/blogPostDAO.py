...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        try:
            cursor = self.posts.find(query).limit(num_posts)
            
            # The $natural parameter returns items according to their order on disk.
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            self.posts.update({'_id':post['_id']}, {'$set':{'comments':comments}}) 
